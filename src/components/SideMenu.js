import { StyleSheet, Text, TouchableOpacity, View, Platform, Dimensions, FlatList } from 'react-native'
  ...
  return (
    <Wrapper style={styles.containerStyle}>
        <View style={styles.header}>
            <TouchableOpacity style={styles.userInfo} onPress={() => navigation.navigate('Login')}>
                        {/* <Ionicons
                            name="person"
                            size={33}
                            color="#4F585E"
                        ...
                        <View style={styles.hairLineBorder}></View>
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        ...Platform.select({
            ios: {
                paddingTop:
                    height > 670 ? (cuHeight < 30 ? 40 : cuHeight + 10) : 30,
            },
            android: {
                paddingTop: 10,
                marginTop: cuHeight,
